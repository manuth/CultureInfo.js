...
{
    it("Checking whether the case of the case of cultures are converted correctly...", () => {
    ...
    it("Checking whether parents are determined correctly...", () => {
    ...
    it("Checking \"CultureInfo to string\"-conversion...", () => {
    ...
    it("Checking the integrity of the IsNeutralCulture-property...", () => {
    ...
    it("Checking the integrity of the invariant culture...", () => {
